...
export function CarouselSize() {
   ...
   const [selectedCity,setSelectedCity]=value
    ...
    const showLatandLong=()=>{
        return(
            <div className="block mt-[20px] mb-[20px] flex justify-between gap-2 w-[70%] font-semibold  text-[15px]">
                <p className="w-[50%] border truncate rounded-md p-2 ">Latitude:{selectedCity.latitude}</p>
                <p className="w-[50%] border truncate rounded-md p-2 ">Longitude:{selectedCity.longitude}</p>
            </div>
        )
    }
